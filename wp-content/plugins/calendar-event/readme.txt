=== Calendar - Event Calendar, Flexible Calendar, Timeline & Events ===
...
*[Event Timeline Calendar Demo Version](http://total-soft.pe.hu/event-timeline-calendar-1/) | [Event Timeline Calendar Demo Version](http://total-soft.pe.hu/event-timeline-calendar-2/) | [Event Timeline Calendar Demo Version](http://total-soft.pe.hu/event-timeline-calendar-3)
...
*  10 free calendar themes with the option of select data ranges, mark events and others (4 versions of the event calendar type, 2 versions of the simple calendar type, 2 versions of the flexible calendar type and 2 versions of the timeline calendar type)
...
*  Total Calendar and Timeline Calendar types each event has its own color.
...
* In this version you are setting events color in general options and its for all events. In Total Calendar and Timeline Calendar types each event has its own color.
...
24. An example of plugin in action (Timeline Calendar)
25. An example of plugin in action (Timeline Calendar)
26. An example of plugin in action (Timeline Calendar)
