	...
	jQuery.fn.jflatTimeline = function(options){
		...
		/**------------------ INSERT DATES BAR------------------**/
			...
			if(!jQuery('.TimleLIne_TS_Cal_'+calid).children(".dates-bar").length)
				jQuery('.TimleLIne_TS_Cal_'+calid).children(".month-year-bar").after('<div class = "dates-bar"><a class = "prev"><i class = "totalsoft totalsoft-'+TimleLIne_TS_Cal_BAT+'-left"></i></a><a class = "noevent">No event found</a><a class = "next"><i class = "totalsoft totalsoft-'+TimleLIne_TS_Cal_BAT+'-right"></i></a></div>')
